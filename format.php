<?php
	...
	echo '
	<div id="titleBox">
		<img STYLE="position:absolute; TOP:5px; LEFT:5px;"  src="pics/BBTitle.png" alt="ALT!!!!">
	...
	<div id="contactBox">
		...
		<a href="http://www.facebook.com/billstaffeldt"><img style="position:relative; top:-2px;" src="pics/facebook.png" width="27" height="26" /></a>
		<a href="http://www.linkedin.com/pub/bill-staffeldt/9/176/168"><img class="button" src="pics/linkedin.png" width="30" height="30" /></a>
		<br>
	</div>';
	...
	function mainPage(){
		echo '
			<div id= "contentBox">
				<center>
				<img src="pics/Me.jpg" height="50%" width="50%" alt="ALT!!!!">
				</center>
				<br>
